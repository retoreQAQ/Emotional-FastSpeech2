            ...
            for batch in batchs:
                ...
                if step % log_step == 0:
                    ...
                    msg = f"Step {step}/{total_step}, " + \
                          f"Total: {loss_values[0]:.4f}, Mel: {loss_values[1]:.4f}, PostNet: {loss_values[2]:.4f}, Delta: {loss_values[3]:.4f}, " + \
                          f"Pitch: {loss_values[4]:.4f}, Energy: {loss_values[5]:.4f}, Duration: {loss_values[6]:.4f}, Emo Loss: {loss_values[7]:.4f}"
                    print(msg)
